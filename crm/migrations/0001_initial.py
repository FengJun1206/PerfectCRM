# Generated by Django 2.1.5 on 2019-04-26 10:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='hj123@qq.com', max_length=255, unique=True, verbose_name='email address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True, verbose_name='校区名字')),
                ('addr', models.CharField(blank=True, max_length=128, null=True, verbose_name='校区地址')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('class_type', models.SmallIntegerField(choices=[(0, '脱产班'), (1, '周末班'), (2, '网络班')], default=0, verbose_name='班级类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_homework', models.BooleanField(default=True, verbose_name='本节课是否有作业')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '近期无报名计划'), (1, '一个月内报名'), (2, '两周内报名'), (3, '已报名')], verbose_name='当前跟踪客户状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default=None, max_length=64, verbose_name='客户姓名')),
                ('contact_type', models.SmallIntegerField(choices=[(0, 'qq'), (1, '微信'), (2, '手机')], default=0, verbose_name='联系方式类型')),
                ('contact', models.CharField(max_length=64, unique=True, verbose_name='联系方式')),
                ('source', models.SmallIntegerField(choices=[(0, 'QQ 群'), (1, '51CTO'), (2, '百度推广'), (3, '知乎'), (4, '转介绍'), (5, '其他')], verbose_name='客户来源途径')),
                ('consult_content', models.TextField(verbose_name='咨询内容')),
                ('status', models.SmallIntegerField(choices=[(0, '未报名'), (1, '已报名'), (2, '已退学')], verbose_name='客户咨询状态')),
                ('id_num', models.CharField(blank=True, max_length=128, null=True, verbose_name='身份证')),
                ('emergency_contract', models.PositiveIntegerField(blank=True, null=True, verbose_name='紧急联系人')),
                ('sex', models.SmallIntegerField(blank=True, choices=[(0, '男'), (1, '女')], null=True, verbose_name='性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_type', models.SmallIntegerField(choices=[(0, 'absolute'), (1, 'dynamic')], default=0, verbose_name='菜单类型（固定|动态）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.IntegerField(default=500, verbose_name='缴纳的费用')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_status', models.SmallIntegerField(choices=[(0, '缺勤'), (1, '已签到'), (2, '迟到'), (3, '早退')], default=1, verbose_name='学员考勤记录')),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.Student', verbose_name='报名的学员')),
            ],
            options={
